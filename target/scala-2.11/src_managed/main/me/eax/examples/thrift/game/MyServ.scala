...
trait MyServ[+MM[_]] extends ThriftService {
  ...
  def listT(idR: String): MM[Seq[Rt]]
  
  def listR(lstT: Seq[String] = Seq[String]()): MM[Seq[Rt]]
  
  def put(where: Short, wt: Rt): MM[Unit]
}
...
object MyServ {
  ...
  object listT$result extends ThriftStructCodec3[listT$result] {
    ...
    val SuccessFieldManifest = implicitly[Manifest[Seq[Rt]]]
    ...
    override def decode(_iprot: TProtocol): listT$result = {
      var success: Option[Seq[Rt]] = None
      var _passthroughFields: Builder[(Short, TFieldBlob), immutable$Map[Short, TFieldBlob]] = null
      var _done = false
    ...
    def apply(
      success: Option[Seq[Rt]] = None
    ): listT$result =
      new listT$result(
        success
      )
  
    def unapply(_item: listT$result): Option[Option[Seq[Rt]]] = Some(_item.success)
  
  
    private def readSuccessValue(_iprot: TProtocol): Seq[Rt] = {
    ...
    private def writeSuccessField(success_item: Seq[Rt], _oprot: TProtocol) {
      _oprot.writeFieldBegin(SuccessField)
      writeSuccessValue(success_item, _oprot)
      _oprot.writeFieldEnd()
    }
  
    private def writeSuccessValue(success_item: Seq[Rt], _oprot: TProtocol) {
  ...
  class listT$result(
      val success: Option[Seq[Rt]],
      val _passthroughFields: immutable$Map[Short, TFieldBlob])
    extends ThriftStruct
    with scala.Product1[Option[Seq[Rt]]]
    with java.io.Serializable
  {
    ...
    def copy(
      success: Option[Seq[Rt]] = this.success,
      _passthroughFields: immutable$Map[Short, TFieldBlob] = this._passthroughFields
    ): listT$result =
      new listT$result(
        success,
  ...
  object listR$result extends ThriftStructCodec3[listR$result] {
    ...
    def unapply(_item: listR$result): Option[Option[Seq[Rt]]] = Some(_item.success)
  ...
  object put$args extends ThriftStructCodec3[put$args] {
    ...
    val WtField = new TField("wt", TType.STRUCT, 2)
    val WtFieldManifest = implicitly[Manifest[Rt]]
        ...
        if (_field.`type` == TType.STOP) {
          ...
          _field.id match {
            ...
            case 2 =>
              _field.`type` match {
                case TType.STRUCT => {
                  wt = readWtValue(_iprot)
                }
                case _actualType =>
                  val _expectedType = TType.STRUCT
            
                  throw new TProtocolException(
                    "Received wrong type for field 'wt' (expected=%s, actual=%s).".format(
                      ttypeToHuman(_expectedType),
                      ttypeToHuman(_actualType)
                    )
                  )
    ...
    def unapply(_item: put$args): Option[scala.Product2[Short, Rt]] = Some(_item)
    ...
    private def readWtValue(_iprot: TProtocol): Rt = {
      Rt.decode(_iprot)
    }
  
    private def writeWtField(wt_item: Rt, _oprot: TProtocol) {
      _oprot.writeFieldBegin(WtField)
      writeWtValue(wt_item, _oprot)
      _oprot.writeFieldEnd()
    }
  
    private def writeWtValue(wt_item: Rt, _oprot: TProtocol) {
      wt_item.write(_oprot)
    }
    ...
    with java.io.Serializable
  {
    ...
    override def write(_oprot: TProtocol) {
      ...
      if (wt ne null) writeWtField(wt, _oprot)
      _passthroughFields.values foreach { _.write(_oprot) }
      _oprot.writeFieldStop()
      _oprot.writeStructEnd()
    }
  ...
  trait FutureIface extends  MyServ[Future] {
    ...
    def listT(idR: String): Future[Seq[Rt]]
    
    def listR(lstT: Seq[String] = Seq[String]()): Future[Seq[Rt]]
    
    def put(where: Short, wt: Rt): Future[Unit]
  }
